...
$_lang['setting_ugm.github_token_desc'] = 'Github token - disponibile nel tuo profilo GitHub';
$_lang['setting_ugm.github_username_desc'] = 'Il tuo username di GitHub';
$_lang['setting_ugm.version_list_path_desc'] = 'Percorso a versionlist file (senza il nome del file -- deve terminare con la barra); Default: {core_path}cache/upgrademodx/';
$_lang['setting_ugm.attempts_desc'] = 'Numero di tentativi per prendere le informazioni da GitHub o da MODX; default: 2';
$_lang['setting_ugm.github_timeout_desc'] = 'Timeout in secondi per il controllo in Github; default: 6';
$_lang['setting_ugm.modx_timeout_desc'] = 'Timeout in secondi per il controllo del download da MODX; default: 6';
$_lang['setting_ugm.groups_desc'] = 'gruppo, o lista separata da virgola di gruppi, che possono vedere il widget';
$_lang['setting_ugm.hideWhenNoUpgrade_desc'] = 'Nascondi il widget quando non ci sono aggiornamenti disponibili: default: No';
$_lang['setting_ugm.interval_desc'] = 'Intervallo tra i controlli -- Esempio: 1 week, 3 days, 6 hours; default: 1 day';
$_lang['setting_ugm.lastCheck_desc'] = 'Data ed ora dell\'ultimo controllo -- imposta automatico';
$_lang['setting_ugm.latestVersion_desc'] = 'Ultima versione (dell\'ultimo controllo) -- imposta automatico';
$_lang['setting_ugm.plOnly_desc'] = 'Mostra solo le versioni pl (stable); default: yes';
$_lang['setting_ugm.versionsToShow_desc'] = 'Numero di versioni da mostrare nel form degli aggiornamenti; default: 5';
$_lang['setting_ugm.language_desc'] = 'Codice della lingua (due lettere) da usare; default: en';
$_lang['setting_ugm.forcePclZip_desc'] = 'Forza l\'uso di PclZip invece di ZipArchive';
$_lang['setting_ugm.forceFopen_desc'] = 'Forza l\'uso di fopen invede di cURL per il download';
$_lang['setting_ugm.ssl_verify_peer_desc'] = 'Per sicurezza, fare verificare a cURL l\'identita del server';
