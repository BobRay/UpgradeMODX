...
$_lang['ugm_get_major_versions'] = '<b>Viktigt:</b> Det är <i>absolut</i> rekomenderat att du installerar alla MODX versioner som slutar med .0 mellan din nuvarande version och aktuell version.</p>';
