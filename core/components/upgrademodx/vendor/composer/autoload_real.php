...
class ComposerAutoloaderInite1ddb72e109c6e1e613a19079efb21dc
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInite1ddb72e109c6e1e613a19079efb21dc::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiree1ddb72e109c6e1e613a19079efb21dc($fileIdentifier, $file);
        }
...
function composerRequiree1ddb72e109c6e1e613a19079efb21dc($fileIdentifier, $file)
{
